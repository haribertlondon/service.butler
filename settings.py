...
LISTEN_TIME_SINCE_HOTWORD_THRESHOLD = LISTEN_PHRASE_PUREPHRASETIME + LISTEN_HOTWORD_MIN_DURATION + LISTEN_PAUSE_TIME_AFTER_PHRASE_THRESHOLD + 0.2
LISTEN_PHRASE_PERCENTAGE = 0.5
